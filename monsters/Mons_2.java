...
public class Mons_2 extends Entity {

    GamePanel gp;

    public Mons_2(GamePanel gp) {
        super(gp);
        this.gp = gp;
    ...
    public void setImage() {
        ...
        up1 = setup("/monsters/darkin/top.1", gp.tileSize, gp.tileSize);
        up2 = setup("/monsters/darkin/top.2", gp.tileSize, gp.tileSize);
        down1 = setup("/monsters/darkin/bot.1", gp.tileSize, gp.tileSize);
        down2 = setup("/monsters/darkin/bot.2", gp.tileSize, gp.tileSize);
        left1 = setup("/monsters/darkin/left.1", gp.tileSize, gp.tileSize);
        left2 = setup("/monsters/darkin/left.2", gp.tileSize, gp.tileSize);
        right1 = setup("/monsters/darkin/right.1", gp.tileSize, gp.tileSize);
        right2 = setup("/monsters/darkin/right.2", gp.tileSize, gp.tileSize);
